...
Core_Test::Core_Test(){
	...
	strs << "LOCATION=" << MY_NODE_ID * 5 << "," << MY_NODE_ID * 5 << ",0";
...
void Core_Test::StartMessaging(){
  ...
  msgTimer = new Timer(5500000, ONE_SHOT, *timerDelegate);
...
void Core_Test::Recv_Handler(FMessage_t& msg){
	...
	Debug_Printf(DBG_TEST, "Core_Test::Received Message from %d\n", msg.GetSource());
}
