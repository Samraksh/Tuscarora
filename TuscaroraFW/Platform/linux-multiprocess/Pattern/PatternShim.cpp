...
#include "Platform/dce/Framework/FrameworkFasade.h"


#include <Base/FrameworkTypes.h>

#include <Lib/Shims/Sockets/SocketClient.h>
...
void PatternShim::SendData (PatternId_t pid, NodeId_t destArray[MAX_DEST], uint16_t noOfDest, FMessage_t& msg, uint16_t nonce, bool noAck)
{
  ...
  void* serial_msg = msg.Serialize(serial_msg_size);
...
void PatternShim::ReplacePayloadRequest(PatternId_t patternId, MessageId_t msgId, void* payload, uint16_t sizeOfPayload)
{
    int calltype = PTN2FW_Call_MethodE::PTN2FW_Call_ReplacePayload;
	SendMsg2Server<int, PatternId_t, MessageId_t, GenericMsgPayloadSize_t, void* >
...
void PatternShim::AddDestinationRequest(PatternId_t patternId, MessageId_t msgId, NodeId_t destArray[MAX_DEST], uint16_t noOfNbrs)
{
...
void PatternShim::AddDestinationRequest(PatternId_t patternId, MessageId_t msgId, NodeId_t destArray[MAX_DEST], uint16_t noOfNbrs, LinkComparatorTypeE lcType)
{
    int calltype = PTN2FW_Call_MethodE::PTN2FW_Call_AddDestwComp;
	SendMsg2Server<int, PatternId_t, MessageId_t, GenericMsgPayloadSize_t, void*, LinkComparatorTypeE >
	(calltype, patternId, msgId, ((GenericMsgPayloadSize_t)noOfNbrs) * sizeof(NodeId_t), (void*)destArray, lcType);
}

void PatternShim::CancelDataRequest(PatternId_t patternId, MessageId_t msgId, NodeId_t destArray[MAX_DEST], uint16_t noOfDest)
{
...
void PatternShim::DataStatusRequest(PatternId_t patternId, MessageId_t msgId)
{
    int calltype = PTN2FW_Call_MethodE::PTN2FW_Call_DataStatus;
	SendMsg2Server<int, PatternId_t, MessageId_t >
