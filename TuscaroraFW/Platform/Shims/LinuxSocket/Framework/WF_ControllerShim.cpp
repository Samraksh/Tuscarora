...
#include "Platform/Shims/LinuxSocket/Framework/WF_ControllerShim.h"
#include "Platform/Shims/LinuxSocket/Framework/Fw2Wf_SocketShim.h"
...
bool WF_ControllerShim::Deserialize (char * buf, uint32_t size, int32_t sockfd){
	...
	switch (msg->eventType) {
		...
		case WF_RECV_MSG_EVT: {
			...
			uint16_t offset=sizeof(WF_RECV_MSG_EVT)+sizeof( FMessageId_t );
