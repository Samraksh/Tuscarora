...
#include "Framework/PWI/PatternDelegates.h"
...
//        GenericSerializer<int,  GenericMsgPayloadSize_t, void*, GenericMsgPayloadSize_t, void*, GenericMsgPayloadSize_t, void*, FMessageId_t , bool, uint16_t >
...
//        bool rv = ptn_controller_ptr->SendMsg2Client(  pid, ptn2fw_msg->GetPayload(), ptn2fw_msg->GetPayloadSize() );
        ...
        bool rv = ptn_controller_ptr->SendMsg2Client<int,  GenericMsgPayloadSize_t, void*, GenericMsgPayloadSize_t, void*, GenericMsgPayloadSize_t, void*, FMessageId_t , bool, uint16_t >
