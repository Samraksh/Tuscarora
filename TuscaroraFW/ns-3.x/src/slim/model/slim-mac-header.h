 ...
 */
#ifndef SLIM_MAC_HEADER_H
#define SLIM_MAC_HEADER_H
...
enum SlimMacType
{
  ...
  SLIM_MAC_CTL_CTS,
  SLIM_MAC_CTL_ACK,
  SLIM_MAC_CTL_BACKREQ,
  SLIM_MAC_CTL_BACKRESP,
  SLIM_MAC_CTL_CTLWRAPPER,

  SLIM_MAC_MGT_BEACON,
  SLIM_MAC_MGT_ASSOCIATION_REQUEST,
  SLIM_MAC_MGT_ASSOCIATION_RESPONSE,
  SLIM_MAC_MGT_DISASSOCIATION,
  SLIM_MAC_MGT_REASSOCIATION_REQUEST,
  SLIM_MAC_MGT_REASSOCIATION_RESPONSE,
  SLIM_MAC_MGT_PROBE_REQUEST,
  SLIM_MAC_MGT_PROBE_RESPONSE,
  SLIM_MAC_MGT_AUTHENTICATION,
  SLIM_MAC_MGT_DEAUTHENTICATION,
  SLIM_MAC_MGT_ACTION,
  SLIM_MAC_MGT_ACTION_NO_ACK,
  SLIM_MAC_MGT_MULTIHOP_ACTION,

  SLIM_MAC_DATA,
  SLIM_MAC_DATA_CFACK,
  SLIM_MAC_DATA_CFPOLL,
  SLIM_MAC_DATA_CFACK_CFPOLL,
  SLIM_MAC_DATA_NULL,
  SLIM_MAC_DATA_NULL_CFACK,
  SLIM_MAC_DATA_NULL_CFPOLL,
  SLIM_MAC_DATA_NULL_CFACK_CFPOLL,
  SLIM_MAC_QOSDATA,
  SLIM_MAC_QOSDATA_CFACK,
  SLIM_MAC_QOSDATA_CFPOLL,
  SLIM_MAC_QOSDATA_CFACK_CFPOLL,
  SLIM_MAC_QOSDATA_NULL,
  SLIM_MAC_QOSDATA_NULL_CFPOLL,
  SLIM_MAC_QOSDATA_NULL_CFACK_CFPOLL,
};

  class SlimDbmHeader : public Header
  {
  public:
 ...
 */
class SlimMacHeader : public Header
{
public:
  /**
   ...
   * on the given type.
   *
   * \param type the SlimMacType for the header
   */
  void SetType (enum SlimMacType type);
  /**
  ...
  /**
   * Return the type (enum SlimMacType)
   *
   * \return the type (enum SlimMacType)
   */
  enum SlimMacType GetType (void) const;
  /**
  ...
  /**
   * Return the size of the SlimMacHeader in octets.
  ...
  /**
   * TracedCallback signature for SlimMacHeader
   *
   * \param [in] header The header 
   */
  typedef void (* TracedCallback)(const SlimMacHeader &header);
