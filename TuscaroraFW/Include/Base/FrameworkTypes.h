...
namespace Types {
  ...
  enum MessageTypeE {
    ...
    ACK_REQUEST_MSG,
//	PATTERN_MSG_REQ_EXP_ACK, //This is a PATTERN_MSG that requires an explicit ACK generated by the receiver framework.
	PATTERN_MSG_FRAGMENTED,
  };
